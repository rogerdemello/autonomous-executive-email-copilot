...
class LLMAgent(BaseBenchmarkAgent):
    ...
    def _get_agent(self):
        if self._agent is None:
            from app.llm.agent import LLMAgent as _LLM
    ...
    def run(
        ...
        from app.llm.agent import get_action as llm_get_action
        from app.llm.agent import reset_agent
...
class ReflectiveAgent(BaseBenchmarkAgent):
    ...
    def run(
        ...
        from research.sim.agents.reflector import ReflectiveAgent as _Reflector
